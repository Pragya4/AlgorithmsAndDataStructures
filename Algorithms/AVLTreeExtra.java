...
int Number(Node r,int x,int y){
int k=Rank(r,x)-Rank(r,y);
return k;
}
int Prefixsum(Node node,int data){
...
public static void main(String args[]){
	...
	System.out.println("Find the element with this rank:");
	int x=s.nextInt();	
	int fr=tree.FindRank(tree.root,x);	
	System.out.println("Element with rank"+x+" : "+fr);
	start=s.nextInt();
	end=s.nextInt();
	int Num_of_num_between_xy=tree.Number(tree.root,start,end);
	System.out.println("Number if numbers between x and y "+Num_of_num_between_xy);
